...
public class testParameters {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		//Saving trees
		Utilities.outputToFile2(testCaseArgs.get(TestingParam.RESULTSPATH.getArgCode())+ "testingArrayListOfTrees", testingProcess.getTreeList());
		Utilities.outputToFile2(testCaseArgs.get(TestingParam.RESULTSPATH.getArgCode())+ "testingArrayListOfTrees", trainingProcess.getTreeList());
